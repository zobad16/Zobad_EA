                       ...
                       bool useLast = true;
                        if(useGridding==true)
                        {
                           ...
                           if(algo.OrderOperationCode(Magic_Number, BUY_LEG1) == true)
                           {
                              ...
                              if( (GridDirection(gDirection,pointsE)/*algo.Pattern_Point_Negative(pointsE, Magic_Number)*/ == REVERSAL_BUY || GridDirection(gDirection,pointsE)== DIRECTIONAL_BUY )&& bcount<numberOfLegs)
                              {
                                 double nlot =0.0;
                              ...
                              else if(useGHedge==true && (GridDirection(gDirection,pointsE) /*algo.Pattern_Point_Negative(pointsE, Magic_Number)*/ == REVERSAL_BUY || GridDirection(gDirection,pointsE)== DIRECTIONAL_BUY )&& bcount==numberOfLegs)
                              {
                           ...
                           {}
                           else if(algo.OrderOperationCode(Magic_Number) == SELL_LEG1)
                              {
                                      // prev_lot = mm.CalculatePositionSize(Magic_Number, SELL_LEG1);
                                       ...
                                       if( (algo.Pattern_Point_Negative(pointsE,Magic_Number) == REVERSAL_SELL || GridDirection(gDirection,pointsE)== DIRECTIONAL_SELL )&& scount<numberOfLegs)
                                       {
                                          double nlot =0.0;
                                        // if(useLast == true && isOrdersTotal(Magic_Number)<_cur_total){
                                             nlot = CalculateLot2(numberOfLegs,increaseLLotBy);
                                       ...
                                       //---------------------------------------------------------------------
                                       else if( useGHedge==true &&(GridDirection(gDirection,pointsE)/*algo.Pattern_Point_Negative(pointsE, Magic_Number)*/ == REVERSAL_SELL ||GridDirection(gDirection,pointsE)== DIRECTIONAL_SELL )&& scount==numberOfLegs)
                                       {
                                             double pre_lot,n_lot= 0.0;
                                             int count , op_c;
