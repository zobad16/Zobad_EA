...
input _type2           lot_type=_MANUAL;                  //Lot Type
...
//input double           _risk=2;                            //Risk Percentage
...
{
   double atr=iATR(Symbol(),0,ATR_Period,0);
   if(SL_Type1 == VOLATILITY)
      return atr * SL_Volatility_Factor1;
   else if(SL_Type1 == FIXED)
      return SL_Fixed1;
   return 0.0;
}
double CalculateLot()
