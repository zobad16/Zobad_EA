...
bool             useGHedge          = false     ;             //Grid::Use Grid Hedge
...
int              increaseLLotBy     = 2         ;             //Grid::Leg Lot Increase Factor(in multiples)
int              decreaseLLotBy     = 2         ;             //Grid::Leg Lot Decrease Factor(in multiples)
...
bool Revised_Buy(int strat, int rt_Code, double n_lot)
{
  ...
  // double lot = mm.CalculatePositionSize(lotType,LotSize,_risk);
   ...
   {       
      mm.PlaceOrderHidden(OP_BUY,n_lot, Magic_Number,(int)comment);
      return true;
   }        
...
bool Revised_Sell(int strat, int rt_Code)
{
   ...
   {        
      mm.PlaceOrderHidden(OP_SELL,lot,Magic_Number,(int)comment);
      return true;
   }        
