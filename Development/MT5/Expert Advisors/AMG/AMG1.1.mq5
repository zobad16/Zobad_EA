...
input E_Grid_Direction     Grid_Direction=Grid_Both;//Grid Direction
input E_SST                Strategy_Type=Mannual;//Strategy Type
...
input double               TP_Point=25000;//TP Point
input double               SL_Point=25000;//SL Point
double               TP_Money=30;//TP Money
double               SL_Money=50;//SL Money
...
{
//---
   int curr_acc = AccountInfoInteger(ACCOUNT_LOGIN);
   ...
   Dialog.Create(ChartID(),"                   WWW.QUANTECHSOL.COM",0,5,5,400,240);
   ...
   TitleBtn.Create(0,"OpenHedge",0,5,6,0,0)                              ;
   TitleBtn.Text("AUTO START TRADE")                                            ;
   TitleBtn.FontSize(11)                                          ;
   ...
   MannualEntryBtn[0].Create(0,"OpenBuy",0,5,30,0,0)                ;
   MannualEntryBtn[0].Text("BUY")                                ;
   MannualEntryBtn[0].FontSize(9)                                    ;   
   MannualEntryBtn[0].Font(FontName);                                  
   MannualEntryBtn[0].Height(25)                                      ;
   ...
   CloseBuysBtn.Create(0,"CloseBuys",0,5,54,0,0)                      ;
   CloseBuysBtn.Text("CLOSE BUYS")                                     ;
   CloseBuysBtn.FontSize(9)                                          ;   
   CloseBuysBtn.Font(FontName);                                  
   CloseBuysBtn.Height(25)                                            ;
   ...
   MannualEntryBtn[1].Create(0,"OpenSell",0,105,30,0,0)                      ;
   MannualEntryBtn[1].Text("SELL")                                     ;
   MannualEntryBtn[1].FontSize(9)                                          ;                                    
   MannualEntryBtn[1].Height(25)                                            ;
   ...
   /*MannualEntryBtn[2].Create(0,"OpenHedge",0,137,30,0,0)                      ;
   MannualEntryBtn[2].Text("HEDGE")                                     ;
   MannualEntryBtn[2].FontSize(9)                                          ;                                    
   MannualEntryBtn[2].Height(25)                                            ;
   MannualEntryBtn[2].Width(68)                                            ;
   MannualEntryBtn[2].Color(clrBlack)                                       ;
   MannualEntryBtn[2].ColorBackground(clrMediumSpringGreen)                               ;
   MannualEntryBtn[2].ColorBorder(clrBlack)                                 ;
   MannualEntryBtn[2].Pressed(false);
   Dialog.Add(MannualEntryBtn[2]);
   */
   reset = false                                                     ; 
   CloseSellsBtn.Create(0,"CloseSells",0,105,54,0,0)                      ;
   CloseSellsBtn.Text("CLOSE SELLS")                                     ;
   CloseSellsBtn.FontSize(9)                                          ;                                    
   CloseSellsBtn.Height(25)                                            ;
   ...
   Labels[0].Create(0,"NPnlLbl",0,230,5,30,0);
   Labels[0].Text("NET PNL$: ");
   Labels[0].FontSize(10);
   Labels[0].Color(clrDarkBlue);   
   
   Dialog.Add(Labels[0]);
   LabelsValues[0].Create(0,"NPNLValue",0,320,5,30,0);
...
//---
   ...
   if(id == CHARTEVENT_OBJECT_CLICK){
    ...
    if(sparam == "OpenHedge"){      
      MessageBox("Opening hedge positions");
      MannualEntry(ORDER_TYPE_SELL);
      MannualEntry(ORDER_TYPE_BUY);
