   ...
   if(Positive_Grid)
   {
      ...
      if( order!=0)
      {
         ...
         if(Count_B<Grid_Max_Leg+1){
            ...
            {
               Print("Total Orders: ["+order+"] Leg trigger-Buy["+IntegerToString(Count_B)+"]");
               ...
               //|| (Strategy_Type == MA_Directional || Strategy_Type == MA_Reversal || Strategy_Type == Mannual ))
                  ...
                  double lot_size_diff = NormalizeDouble(lots*MathPow(Grid_Lot_Multiplier,Count_B),2);
         ...
         if(Count_S<Grid_Max_Leg+1)
         {
            ...
            //|| (Strategy_Type == MA_Directional || Strategy_Type == MA_Reversal|| Strategy_Type == Mannual)){
               ...
               {
                  Print("Total Orders: ["+order+"] Leg trigger-Sell["+(Count_S)+"]");
