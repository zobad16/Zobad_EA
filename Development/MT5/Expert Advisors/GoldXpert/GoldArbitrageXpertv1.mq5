...
//OBJPROP_BORDER_TYPE
   ...
   InputParams[0].Create(0,"BenchmarkEdit",0,160,100,0,0);
   ...
   InputParams[1].Create(0,"BuyEdit",0,160,125,0,0);
   ...
   InputParams[2].Create(0,"SellEdit",0,160,150,0,0);
   ...
   InputParams[7].Create(0,"Grid_Edit",0,160,175,0,0);
   ...
   InputParams[8].Create(0,"LegTP_Edit",0,160,200,0,0);
   ...
   InputParams[5].Create(0,"TPEdit",0,160,225,0,0);
   ...
   InputParams[6].Create(0,"SLEdit",0,160,250,0,0);
   ...
   LabelsValues[0].Create(0,"Pnl_Value",0,355,100,0,0);
   ...
   StatsValues_Lbl[0].Create(0,"DeltaHigh_Value",0,355,120,0,0);
   ...
   StatsValues_Lbl[1].Create(0,"DeltaLow_Value",0,355,140,0,0);
   ...
   StatsValues_Lbl[2].Create(0,"Legs_Value",0,355,160,0,0);
   ...
   EntryAtValue.Create(0,"Next_Value",0,355,180,0,0);
   EntryAtValue.Text("0");
