...
input string   Symbol2="EURGBP.r";
input string   Symbol3="EURAUD.r";
input string   Symbol4="EURNZD.r";
input string   Symbol5="EURCAD.r";
input string   Symbol6="EURCHF.r";
input string   Symbol7="EURJPY.r";
input string   Symbol8="GBPUSD.r";
input string   Symbol9="GBPCAD.r";
input string   Symbol10="GBPAUD.r";
input string   Symbol11="GBPNZD.r";
input string   Symbol12="GBPCHF.r";
input string   Symbol13="GBPJPY.r";
input string   Symbol14="USDJPY.r";
input string   Symbol15="CHFJPY.r";
input string   Symbol16="CADJPY.r";
input string   Symbol17="USDCAD.r";
input string   Symbol18="USDCHF.r";
input string   Symbol19="CADCHF.r";
input string   Symbol20="AUDUSD.r";
input string   Symbol21="AUDCHF.r";
input string   Symbol22="AUDCAD.r";
input string   Symbol23="NZDUSD.r";
input string   Symbol24="NZDCAD.r";
input string   Symbol25="NZDCHF.r";
input string   Symbol26="NZDJPY.r";
input string   Symbol27="AUDJPY.r";
input string   Symbol28="NZDCAD.r";
...
//--- create timer
   ...
   SetSymbols();
      ...
      if(!is_set_handles){
       ...
       Dialog.Create(ChartID(),"                   WWW.QUANTECHSOL.COM",0,5,5,700,250);
...
void CreateLabels(){
   CreateLabel(Dialog,Labels[0],"Title",75,5,"RSI Scanner",14,clrWhite);
   //Headers
   ...
   */
   ...
   CreateLabel(Dialog,H_Labels[2],"RSILBL",95,40,"RSI",9,clrWhite);
   CreateLabel(Dialog,H_Labels[3],"RSILBL2",255,40,"RSI",9,clrWhite);
   CreateLabel(Dialog,H_Labels[4],"SymbolLbl3",335,40,"Symbols",9,clrWhite);
   CreateLabel(Dialog,H_Labels[5],"RSILBL3",415,40,"RSI",9,clrWhite);
   CreateLabel(Dialog,H_Labels[6],"SymbolLbl4",495,40,"Symbols",9,clrWhite);   
   CreateLabel(Dialog,H_Labels[7],"RSILbl5",575,40,"Symbols",9,clrWhite);
      ...
      CreateLabel(Dialog,LabelsValues[1],"RSIS1",95,65,"0.0",9,clrWhite);
      CreateLabel(Dialog,LabelsValues[2],"RSIS2",95,85,"0.0",9,clrWhite);
      CreateLabel(Dialog,LabelsValues[3],"RSIS3",95,105,"0.0",9,clrWhite);
      CreateLabel(Dialog,LabelsValues[4],"RSIS4",95,125,"0.0",9,clrWhite);
      CreateLabel(Dialog,LabelsValues[5],"RSIS5",95,145,"0.0",9,clrWhite);
      CreateLabel(Dialog,LabelsValues[6],"RSIS6",95,165,"0.0",9,clrWhite);
      CreateLabel(Dialog,LabelsValues[7],"RSIS7",95,185,"0.0",9,clrWhite);
      CreateLabel(Dialog,LabelsValues[8],"RSIS8",255,65,"0.0",9,clrWhite);
      CreateLabel(Dialog,LabelsValues[9],"RSIS9",255,85,"0.0",9,clrWhite);
      CreateLabel(Dialog,LabelsValues[10],"RSIS10",255,105,"0.0",9,clrWhite);
      CreateLabel(Dialog,LabelsValues[11],"RSIS11",255,125,"0.0",9,clrWhite);
      CreateLabel(Dialog,LabelsValues[12],"RSIS12",255,145,"0.0",9,clrWhite);
      CreateLabel(Dialog,LabelsValues[13],"RSIS13",255,165,"0.0",9,clrWhite);
      CreateLabel(Dialog,LabelsValues[14],"RSIS14",255,185,"0.0",9,clrWhite);
      ...
      CreateLabel(Dialog,LabelsValues[15],"RSIS15",415,65,"0.0",9,clrWhite);
      CreateLabel(Dialog,LabelsValues[16],"RSIS16",415,85,"0.0",9,clrWhite);
      CreateLabel(Dialog,LabelsValues[17],"RSIS17",415,105,"0.0",9,clrWhite);
      CreateLabel(Dialog,LabelsValues[18],"RSIS18",415,125,"0.0",9,clrWhite);
      CreateLabel(Dialog,LabelsValues[19],"RSIS19",415,145,"0.0",9,clrWhite);
      CreateLabel(Dialog,LabelsValues[20],"RSIS20",415,165,"0.0",9,clrWhite);
      CreateLabel(Dialog,LabelsValues[21],"RSIS21",415,185,"0.0",9,clrWhite);
      ...
      CreateLabel(Dialog,LabelsValues[22],"RSI22",575,65,"0.0",9,clrWhite);
      CreateLabel(Dialog,LabelsValues[23],"RSI23",575,85,"0.0",9,clrWhite);
      CreateLabel(Dialog,LabelsValues[24],"RSI24",575,105,"0.0",9,clrWhite);
      CreateLabel(Dialog,LabelsValues[25],"RSI25",575,125,"0.0",9,clrWhite);
      CreateLabel(Dialog,LabelsValues[26],"RSI26",575,145,"0.0",9,clrWhite);
      CreateLabel(Dialog,LabelsValues[27],"RSI27",575,165,"0.0",9,clrWhite);
      CreateLabel(Dialog,LabelsValues[28],"RSI28",575,185,"0.0",9,clrWhite);
}