...
//---
   ...
   //if(VOLATILITY_Range==true && atr<= (VOLATILITY_Range_High*MyPoint) && atr>=(VOLATILITY_Range_Low*MyPoint))
   ...
   /*if(TotalOpenOrder()==0)
   {
      ...
      if(BuyAlert()==true && IsNewBar())
      {
         ...
         //first change
         double atr=iATR(0,0,ATR_Period,0);
         Print("ATR Re\ding ",atr);
         Print("ATR Re\ding ",VOLATILITY_Range_Low*MyPoint);
         if(VOLATILITY_Range==true && atr>= (VOLATILITY_Range_Low*MyPoint) && atr<=(VOLATILITY_Range_High*MyPoint))
         {
            Print("ATR MET");
            if(SCALPER==false)
         ...
         else if( VOLATILITY_Range == false)
         {
            if(SCALPER== false )
            {
              Print("Sculpter False Method Running"); 
